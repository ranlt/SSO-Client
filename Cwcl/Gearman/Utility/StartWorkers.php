 ...
 * @package Cwcl
 **/
class Cwcl_Gearman_Utility_StartWorkers
{
	...
	static public function start($name = 'All', $factory = 'default', $env = NULL)
	{
		...
		$factoryCall = 'Cwcl_Gearman_Worker_Factory_' . ucwords($factory);
...
if (isset($argv) && count($argv) > 1) {
	array_shift($argv);
	call_user_func_array('Cwcl_Gearman_Utility_StartWorkers::start', $argv);
}